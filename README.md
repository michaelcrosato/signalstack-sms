...
The API operations inventory is frozen at export, and status calls return fresh frozen route snapshots so caller-side mutation cannot drift local API inventory renders.
