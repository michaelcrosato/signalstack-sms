...
- Unit tests must verify shared operator projection links expose only public navigation fields so extra runtime properties on supplied inventories cannot leak into rendered local navigation.
