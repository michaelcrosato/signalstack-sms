...
- The seeded product demo path must verify `/dashboard` renders owner-facing local analytics signals including fake-AI usage visibility without provider calls, billing, live AI, SMS, notifications, secrets, report execution, exports, mutations, or live feature enablement.
