...
Exact frozen control-array evidence must also remain authorized without invoking data-backed inherited `Array.prototype[Symbol.iterator]` or `Array.prototype[Symbol.asyncIterator]` metadata.
