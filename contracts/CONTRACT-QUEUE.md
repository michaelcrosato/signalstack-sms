...
Control arrays with own `Symbol.toStringTag`, `Symbol.asyncIterator`, `Symbol.unscopables`, `Symbol.isConcatSpreadable`, string-method symbol metadata (`Symbol.match`, `Symbol.matchAll`, `Symbol.replace`, `Symbol.search`, or `Symbol.split`), `Symbol.toPrimitive`, `toString`, or `valueOf` metadata must deny without reading or invoking those hooks.
