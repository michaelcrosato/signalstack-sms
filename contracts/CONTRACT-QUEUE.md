...
Exact-field, proxy-backed, and revoked proxy-backed non-ordinary authorization-wrapper impostors, including null-prototype and class-instance wrappers, must deny before supplied controls are inspected and without reading wrapper field getters.
