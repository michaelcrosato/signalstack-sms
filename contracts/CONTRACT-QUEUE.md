...
Proxy-backed non-array `controls` evidence, including array buffers and shared array buffers, must deny before object `get`, prototype, descriptor, or key traps are read.
