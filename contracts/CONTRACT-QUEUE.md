...
Exact-field, proxy-backed, and revoked proxy-backed non-ordinary authorization-wrapper impostors, including null-prototype, class-instance, array-shaped, and function-shaped wrappers, must deny before supplied controls are inspected and without reading wrapper field getters. Revoked proxy-backed plain authorization wrappers must also deny cleanly before hostile supplied controls are inspected.
