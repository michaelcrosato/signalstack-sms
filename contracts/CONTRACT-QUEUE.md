...
Exact frozen control-array density and descriptor-enumerability evidence must also remain independent from inherited `Object.prototype.hasOwnProperty` ownership-helper and `Object.prototype.propertyIsEnumerable` enumerability-helper metadata, including accessor-backed or data-backed callable metadata.
