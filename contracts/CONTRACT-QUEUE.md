...
Every runtime-supported typed-array constructor must deny as direct controls evidence and as an authorization-wrapper impostor before the reserved worker class can authorize.
