...
Control arrays with own `Symbol.toStringTag`, `Symbol.asyncIterator`, `Symbol.toPrimitive`, `toString`, or `valueOf` metadata must deny without reading or invoking those hooks.
