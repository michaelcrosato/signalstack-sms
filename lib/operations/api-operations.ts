...
export const apiOperationRoutes = freezeApiOperationRoutes([
  ...
  { method: "POST", path: "/api/ai/campaign-copy", area: "AI", mutates: true, externalImpact: false, safety: "fake provider and local AI usage metering only" },
  { method: "POST", path: "/api/ai/reply-suggestion", area: "AI", mutates: true, externalImpact: false, safety: "fake provider and local AI usage metering only" },
  { method: "POST", path: "/api/ai/conversation-summary", area: "AI", mutates: true, externalImpact: false, safety: "fake provider and local AI usage metering only" },
  { method: "POST", path: "/api/ai/lead-qualification", area: "AI", mutates: true, externalImpact: false, safety: "fake provider and local AI usage metering only" },
