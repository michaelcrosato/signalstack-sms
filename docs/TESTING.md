...
- The seeded investor demo path verifies `/settings/operations` as a read-only grouped local operator surface index without commands, file inspection, API probes, mutations, exports, provider calls, billing, notifications, live AI, SMS, email, secrets, or live feature enablement.
