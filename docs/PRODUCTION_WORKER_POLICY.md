...
Built-in object-shaped deployment-class impostors, including maps, sets, typed arrays, data views, promises, regular expressions, and errors, must deny before supplied controls are inspected.
