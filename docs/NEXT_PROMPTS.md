...
- Latest validated run: Run 770 added a read-only campaign detail delivery snapshot from existing local message rows, with focused product projection coverage and a product-demo assertion.
