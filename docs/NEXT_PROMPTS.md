...
- Latest validated run: Run 785 makes local delivered counts exclude rows with terminal failure evidence, keeping delivered and failed delivery reporting mutually exclusive even if stale `deliveredAt` metadata is present.
