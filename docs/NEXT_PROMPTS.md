...
- Latest validated run: Run 813 routes GitHub CI and premerge validation through the protected local gate so workflow green status includes gate-integrity verification before `npm run validate`.
