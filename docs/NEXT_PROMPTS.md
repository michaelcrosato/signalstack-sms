...
- Latest validated run: Run 775 kept product campaign detail delivery snapshots scoped to outbound message rows, with focused campaign detail unit coverage.
