...
- The browser product now has an initial `/dashboard` shell, but most deeper flows are still read-only `/settings/**` operations surfaces, not polished owner/operator workflows.
