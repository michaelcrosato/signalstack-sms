...
- Latest validated run: Run 802 adds a campaign-detail `Recent Evidence Rows` metric showing visible recent outbound evidence rows against the all-outbound local message total.
