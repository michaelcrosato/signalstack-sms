...
- Good candidate slices: provider credential management, Redis-backed BullMQ integration smoke, API rate limiting, deeper settings UI, or production deployment gates.
