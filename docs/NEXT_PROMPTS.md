...
2. Convert the planning-only `production-live-campaign` controls into executable gates before adding any supported live worker class or live-provider campaign sends.
