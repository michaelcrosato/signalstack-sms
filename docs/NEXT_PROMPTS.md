...
- Good candidate slices: UI expansion, provider credential management, Redis-backed BullMQ integration smoke, API rate limiting, live-readiness audit UI, or production deployment gates.
