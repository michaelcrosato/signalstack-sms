...
- Latest validated run: Run 800 makes campaign-detail delivery metrics aggregate all outbound campaign messages while keeping visible delivery rows recent-only.
