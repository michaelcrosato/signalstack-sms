...
- Campaign schedule route coverage now proves role denials return before request-body parsing, and malformed or schema-invalid JSON returns `400` before local queue scheduling or BullMQ enqueue helpers can run.
