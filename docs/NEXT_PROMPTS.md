...
1. Harden production worker policy before broader live sending.
2. Add campaign detail/edit/cancel only if product demo review needs deeper lifecycle control.
