...
Run 762 note: mutating-route auth scanner coverage now includes comma-declared sequence-wrapped conditional/logical local `globalThis` root aliases, including `const root = (void 0, condition ? globalThis : globalThis), platform = (undefined, condition ? root : root), runtime = (0, true ? platform : platform)` and `const root = (void 0, globalThis || globalThis), platform = (undefined, root ?? root), runtime = (0, platform && platform)`, before `Request`, `Object`, and `Reflect` destructuring reaches prototype/descriptor body-reader calls.

Run 761 note: mutating-route auth scanner coverage now includes comma-declared logical-expression local `globalThis` root aliases, including `const root = globalThis || globalThis, platform = root ?? root, runtime = platform && platform`, before `Request`, `Object`, and `Reflect` destructuring reaches prototype/descriptor body-reader calls.
...
Run 757 note: mutating-route auth scanner coverage now includes sequence-wrapped conditional/logical expression right-hand sides inside local `globalThis` logical-assignment chains, including `root ??= (void 0, condition ? globalThis : globalThis); platform ||= (undefined, root ?? root); runtime &&= (0, platform && platform)`, before `Request`, `Object`, and `Reflect` destructuring reaches prototype/descriptor body-reader calls.

Run 756 note: mutating-route auth scanner coverage now includes sequence-wrapped logical-assignment local `globalThis` root aliases for `Request` constructor aliases and `Object`/`Reflect` aliases, including `root ??= (void 0, globalThis); platform ||= (undefined, root); runtime &&= (0, platform)`, before prototype/descriptor body-reader calls.

Run 755 note: mutating-route auth scanner coverage now includes sequence-wrapped conditional and logical local `globalThis` root aliases for `Request` constructor aliases and `Object`/`Reflect` aliases, including `root = (void 0, condition ? globalThis : globalThis); platform = (undefined, condition ? root : root); runtime = (0, true ? platform : platform)` and `root = (void 0, globalThis || globalThis); platform = (undefined, root ?? root); runtime = (0, platform && platform)`, before prototype/descriptor body-reader calls.
...
Run 751 note: mutating-route auth scanner coverage now includes comma-expression logical assignment local `globalThis` root aliases for `Request` constructor aliases and `Object`/`Reflect` aliases, including `((root ??= globalThis), (platform ||= root), (runtime &&= platform))`, before prototype/descriptor body-reader calls.

Run 750 note: mutating-route auth scanner coverage now includes logical-and assignment local `globalThis` root aliases for `Request` constructor aliases and `Object`/`Reflect` aliases, including `root &&= globalThis; platform &&= root; runtime &&= platform`, before prototype/descriptor body-reader calls.

Run 749 note: mutating-route auth scanner coverage now includes nullish/fallback logical assignment local `globalThis` root aliases for `Request` constructor aliases and `Object`/`Reflect` aliases, including `root ??= globalThis; platform ||= root; runtime ??= platform`, before prototype/descriptor body-reader calls.

Run 748 note: mutating-route auth scanner coverage now includes parenthesized assignment comma-expression non-null local `globalThis` root aliases for `Request` constructor aliases and `Object`/`Reflect` aliases, including `(((root = (globalThis)!), (platform = ((root)!)), (runtime = ((platform)!))))`, before prototype/descriptor body-reader calls.

Run 747 note: mutating-route auth scanner coverage now includes parenthesized assignment comma-expression local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `((root = globalThis), (platform = root), (runtime = platform))`, before prototype/descriptor body-reader calls.

Run 746 note: mutating-route auth scanner coverage now includes parenthesized assignment-expression non-null multi-hop local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `((root = (globalThis)!)); ((platform = ((root)!))); ((runtime = ((platform)!)))`, before prototype/descriptor body-reader calls.

Run 745 note: mutating-route auth scanner coverage now includes parenthesized assignment-expression multi-hop local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `(root = globalThis); (platform = root); (runtime = platform)`, before prototype/descriptor body-reader calls.

Run 744 note: mutating-route auth scanner coverage now includes typed declaration multi-hop local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `const root: typeof globalThis = globalThis; let platform: typeof globalThis = root; var runtime: typeof globalThis = platform`, before prototype/descriptor body-reader calls.
...
Run 740 note: mutating-route auth scanner coverage now includes multi-hop assigned whole-parenthesized non-null local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `root = (globalThis)!; platform = ((root)!); runtime = ((platform)!)`, before prototype/descriptor body-reader calls.

Run 739 note: mutating-route auth scanner coverage now includes multi-hop assigned transitive local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `root = globalThis; platform = root; runtime = platform`, before prototype/descriptor body-reader calls.

Run 738 note: mutating-route auth scanner coverage now includes multi-hop assigned non-null transitive local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `root = globalThis; platform = root!; runtime = platform!`, before prototype/descriptor body-reader calls.

Run 737 note: mutating-route auth scanner coverage now includes multi-hop assigned parenthesized non-null transitive local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `root = globalThis; platform = (root)! as typeof globalThis; runtime = ((platform as typeof globalThis)!)`, before prototype/descriptor body-reader calls.

Run 736 note: mutating-route auth scanner coverage now includes multi-hop comma-declared parenthesized non-null transitive local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `const root = globalThis, platform = (root)! as typeof globalThis, runtime = ((platform as typeof globalThis)!)`, before prototype/descriptor body-reader calls.

Run 735 note: mutating-route auth scanner coverage now includes multi-hop comma-declared non-null transitive local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `const root = globalThis, platform = root!, runtime = platform!`, before prototype/descriptor body-reader calls.

Run 734 note: mutating-route auth scanner coverage now includes multi-hop comma-declared transitive local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `const root = globalThis, platform = root, runtime = platform`, before prototype/descriptor body-reader calls.
...
Run 730 note: mutating-route auth scanner coverage now includes whole-parenthesized asserted non-null transitive local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `const platform = ((root as typeof globalThis)!)` and `platform = ((root satisfies typeof globalThis)!)`, before prototype/descriptor body-reader calls.

Run 729 note: mutating-route auth scanner coverage now includes parenthesized non-null transitive local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `const platform = (root)! as typeof globalThis`, `platform = ((root)! satisfies typeof globalThis)`, and destructuring from `(platform)! as typeof globalThis`, before prototype/descriptor body-reader calls.

Run 728 note: mutating-route auth scanner coverage now includes non-null transitive local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `const root = globalThis; const platform = root!; const { Request: RequestCtor = Request } = platform` and `platform = root! as typeof globalThis; ({ [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = platform)`, before prototype/descriptor body-reader calls.

Run 727 note: mutating-route auth scanner coverage now includes transitive local `globalThis` root aliases for both `Request` constructor aliases and `Object`/`Reflect` aliases, including `const root = globalThis; const platform = root; const { Request: RequestCtor = Request } = platform` and `platform = root as typeof globalThis; ({ [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = platform)`, before prototype/descriptor body-reader calls.
...
Run 710 note: mutating-route auth scanner coverage now includes assigned local `globalThis` root aliases feeding computed optional non-null `Request` constructor aliases, including `root = globalThis as typeof globalThis; const RequestCtor = root?.[requestConstructorName]! as typeof Request` and `root = (globalThis satisfies typeof globalThis); RequestCtor = root?.[requestConstructorName]! satisfies typeof Request`, before `Request.prototype` body-reader calls, proving those body readers must remain after each route handler's own top-level `requireApiRole`.

Run 709 note: mutating-route auth scanner coverage now includes unparenthesized `satisfies` computed optional non-null `Request` constructor aliases through local `globalThis` aliases, including `const RequestCtor = root?.[requestConstructorName]! satisfies typeof Request` and `RequestCtor = root?.[requestConstructorName]! satisfies typeof Request`, before `Request.prototype` body-reader calls, proving those body readers must remain after each route handler's own top-level `requireApiRole`.

Run 708 note: mutating-route auth scanner coverage now includes whole-parenthesized type-asserted computed optional non-null `Request` constructor aliases through local `globalThis` aliases, including `const RequestCtor = (root?.[requestConstructorName]! as typeof Request)` and `RequestCtor = (root?.[requestConstructorName]! as typeof Request)`, before `Request.prototype` body-reader calls, proving those body readers must remain after each route handler's own top-level `requireApiRole`.

Run 707 note: mutating-route auth scanner coverage now includes assigned computed optional non-null `Request` constructor aliases through local `globalThis` aliases, including `RequestCtor = root?.[requestConstructorName]! as typeof Request` and `RequestCtor = root?.[requestConstructorName]! satisfies typeof Request`, before `Request.prototype` body-reader calls, proving those body readers must remain after each route handler's own top-level `requireApiRole`.

Run 706 note: mutating-route auth scanner coverage now includes computed optional non-null `Request` constructor aliases through local `globalThis` aliases, including `root?.[requestConstructorName]! as typeof Request` and `root?.[requestConstructorName]! satisfies typeof Request`, before `Request.prototype` body-reader calls, proving those body readers must remain after each route handler's own top-level `requireApiRole`.

Run 705 note: mutating-route auth scanner coverage now includes direct `const` computed optional non-null `globalThis?.[requestConstructorName]!` Request constructor aliases followed by `as typeof Request` or `satisfies typeof Request` before `Request.prototype` body-reader calls, proving those body readers must remain after each route handler's own top-level `requireApiRole`.

Run 704 note: mutating-route auth scanner coverage now includes computed optional non-null `globalThis?.[requestConstructorName]!` Request constructor aliases in direct, assigned type-asserted, and assigned `satisfies` forms before `Request.prototype` body-reader calls, proving those body readers must remain after each route handler's own top-level `requireApiRole`.

Run 703 note: mutating-route auth scanner coverage now includes non-null optional-dot and optional-bracket `globalThis?.Request!` constructor aliases followed by `as typeof Request` or `satisfies typeof Request` in direct `const` and assigned forms before `Request.prototype` body-reader calls, proving those body readers must remain after each route handler's own top-level `requireApiRole`.
