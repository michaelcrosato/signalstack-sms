...
| Queue/Worker | Durable jobs, dummy worker, optional BullMQ/Redis mirror and worker. | Queue operations page. | Send-time consent recheck and production worker policy need hardening. | Add send-time consent recheck and tests before live sends. |
