...
import { assertFakeAiProvider, fakeReplySuggestion } from "@/lib/ai/fake-ai-provider";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json(fakeReplySuggestion({ messages, goal: payload.data.goal }));
  } catch (error) {
