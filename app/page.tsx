    ...
    <SettingsLayout>
      <section className="space-y-4 border-b border-slate-200 pb-6">
        ...
        <p className="max-w-2xl text-lg leading-8 text-slate-700">
          Demo-safe command center for the local SMB texting SaaS
          implementation. Live messaging, billing, provider calls,
          notifications, and live AI remain blocked by default.
        </p>
      </section>

      <section
        className="grid gap-4 md:grid-cols-2 lg:grid-cols-3"
        aria-label="Local views"
      >
        <Link
        ...
        >
          ...
          <span className="mt-2 block text-sm leading-6 text-slate-600">
            Work from the product-facing contacts, campaigns, inbox, analytics,
            and compliance shell.
          </span>
        </Link>
