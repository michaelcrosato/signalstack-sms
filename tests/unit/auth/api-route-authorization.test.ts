...
describe("API route authorization coverage", () => {
  ...
  it("treats Request prototype body readers as body parsing for role-gate ordering", () => {
    ...
    `;
    const unsafeAssignedTypeAssertedDirectRequestAliasSource = `
      export async function PUT(req: Request) {
        let RequestCtor;
        RequestCtor = Request as typeof Request;
    ...
    `;
    const unsafeTypeAssertedGlobalThisRootRequestAliasSource = `
      export async function DELETE(req: Request) {
    ...
    `;
    const unsafeAssignedTypeAssertedOptionalBracketGlobalThisRequestAliasSource = `
      export async function DELETE(req: Request) {
        let RequestCtor;
    ...
    `;
    const unsafeAssignedNonNullOptionalDotGlobalThisRequestAliasSource = `
      export async function PUT(req: Request) {
        let RequestCtor;
        RequestCtor = globalThis?.Request!;
        const payload = await RequestCtor.prototype.arrayBuffer.call(req);
    ...
    `;
    const unsafeAssignedNonNullOptionalBracketGlobalThisRequestAliasSource = `
      export async function DELETE(req: Request) {
        let RequestCtor;
        RequestCtor = globalThis?.["Request"]!;
        const payload = await RequestCtor.prototype.json.call(req);
    ...
    `;
    const unsafeTypeAssertedOptionalDotGlobalThisRequestAliasSource = `
      export async function PATCH(req: Request) {
        const RequestCtor = globalThis?.Request as typeof Request;
        const payload = await RequestCtor.prototype.arrayBuffer.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
    ...
    `;
    const unsafeSatisfiesOptionalDotGlobalThisRequestAliasSource = `
      export async function PATCH(req: Request) {
        const RequestCtor = (globalThis?.Request satisfies typeof Request);
        const payload = await RequestCtor.prototype.formData.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
    ...
    `;
    const unsafeOptionalBracketGlobalThisRequestAliasSource = `
      export async function DELETE(req: Request) {
        const RequestCtor = globalThis?.["Request"];
        const payload = await RequestCtor.prototype.blob.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
    ...
    `;
    const unsafeTypeAssertedOptionalBracketGlobalThisRequestAliasSource = `
      export async function DELETE(req: Request) {
        const RequestCtor = globalThis?.["Request"] as typeof Request;
        const payload = await RequestCtor.prototype.json.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
    ...
    `;
    const unsafeSatisfiesOptionalBracketGlobalThisRequestAliasSource = `
      export async function DELETE(req: Request) {
        const RequestCtor = (globalThis?.["Request"] satisfies typeof Request);
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
    ...
    `;
    const unsafeNonNullOptionalDotGlobalThisRequestAliasSource = `
      export async function PATCH(req: Request) {
        const RequestCtor = globalThis?.Request!;
        const payload = await RequestCtor.prototype.blob.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
    ...
    `;
    const unsafeNonNullOptionalBracketGlobalThisRequestAliasSource = `
      export async function DELETE(req: Request) {
        const RequestCtor = globalThis?.["Request"]!;
        const payload = await RequestCtor.prototype.formData.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
    ...
    `;
    const unsafeComputedNonNullOptionalGlobalThisRequestAliasSource = `
      export async function POST(req: Request) {
        const requestConstructorName = "Request" as const;
        const RequestCtor = globalThis?.[requestConstructorName]!;
        const payload = await RequestCtor.prototype.text.call(req);
    ...
    `;
    const unsafeTypeAssertedComputedNonNullOptionalGlobalThisRequestAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request";
        const RequestCtor = globalThis?.[requestConstructorName]! as typeof Request;
        const payload = await RequestCtor.prototype.blob.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ size: payload.size });
    ...
    `;
    const unsafeSatisfiesComputedNonNullOptionalGlobalThisRequestAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        const RequestCtor = (globalThis?.[requestConstructorName]! satisfies typeof Request);
        const payload = await RequestCtor.prototype.json.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json(payload);
    ...
    `;
    const unsafeAssignedComputedNonNullOptionalGlobalThisRequestAliasSource = `
      export async function PUT(req: Request) {
        const requestConstructorName = "Request";
        let RequestCtor;
        RequestCtor = (globalThis?.[requestConstructorName]! as typeof Request);
        const payload = await RequestCtor.prototype.arrayBuffer.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ size: payload.byteLength });
    ...
    `;
    const unsafeAssignedComputedSatisfiesNonNullOptionalGlobalThisRequestAliasSource = `
      export async function DELETE(req: Request) {
        const requestConstructorName = "Request";
        let RequestCtor;
        RequestCtor = (globalThis?.[requestConstructorName]! satisfies typeof Request);
        const payload = await RequestCtor.prototype.formData.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ ok: Boolean(payload) });
    ...
    `;
    const unsafeAssignedDestructuredGlobalThisRequestAliasSource = `
      export async function PUT(req: Request) {
        let RequestCtor;
        ({ Request: RequestCtor } = globalThis);
        const payload = await RequestCtor.prototype.json.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json(payload);
    ...
    `;
    const unsafeAssignedComputedDestructuredGlobalThisRequestAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let RequestCtor;
        ({ [requestConstructorName]: RequestCtor } = globalThis);
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ payload });
    ...
    `;
    const unsafeDefaultedDestructuredGlobalThisRequestAliasSource = `
      export async function PUT(req: Request) {
        const { Request: RequestCtor = Request } = globalThis;
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ payload });
    ...
    `;
    const unsafeDefaultedComputedDestructuredGlobalThisRequestAliasSource = `
      export async function DELETE(req: Request) {
        const requestConstructorName = "Request" as const;
        const { [requestConstructorName]: RequestCtor = Request } = globalThis;
        const payload = await RequestCtor.prototype.arrayBuffer.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ size: payload.byteLength });
    ...
    `;
    const unsafeAssignedDefaultedDestructuredGlobalThisRequestAliasSource = `
      export async function POST(req: Request) {
        let RequestCtor;
        ({ Request: RequestCtor = Request } = globalThis);
        const payload = await RequestCtor.prototype.json.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json(payload);
    ...
    `;
    const unsafeAssignedDefaultedComputedDestructuredGlobalThisRequestAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let RequestCtor;
        ({ [requestConstructorName]: RequestCtor = Request } = globalThis);
        const payload = await RequestCtor.prototype.formData.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ ok: Boolean(payload) });
    ...
    `;
    const unsafeRootAliasDefaultedDestructuredGlobalThisRequestAliasSource = `
      export async function DELETE(req: Request) {
        const root = globalThis;
        const { Request: RequestCtor = Request } = root;
        const payload = await RequestCtor.prototype.blob.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ size: payload.size });
    ...
    `;
    const unsafeRootAliasDefaultedComputedDestructuredGlobalThisRequestAliasSource = `
      export async function PUT(req: Request) {
        const root = globalThis as typeof globalThis;
        const requestConstructorName = "Request" as const;
        const { [requestConstructorName]: RequestCtor = Request } = root;
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ payload });
    ...
    `;
    const unsafeAssignedRootAliasDefaultedDestructuredGlobalThisRequestAliasSource = `
      export async function PATCH(req: Request) {
        let root;
        let RequestCtor;
        root = (globalThis satisfies typeof globalThis);
        ({ Request: RequestCtor = Request } = root);
        const payload = await RequestCtor.prototype.formData.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ ok: Boolean(payload) });
    ...
    `;
    const unsafeAssignedTypeAssertedRootAliasDefaultedDestructuredGlobalThisRequestAliasSource = `
      export async function PATCH(req: Request) {
        let root;
        let RequestCtor;
    ...
    `;
    const unsafeAssignedRootAliasDefaultedComputedDestructuredGlobalThisRequestAliasSource = `
      export async function DELETE(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let RequestCtor;
        root = (globalThis as typeof globalThis);
        ({ [requestConstructorName]: RequestCtor = Request } = root);
        const payload = await RequestCtor.prototype.blob.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ size: payload.size });
    ...
    `;
    const unsafeAssignedSatisfiesRootAliasDefaultedComputedDestructuredGlobalThisRequestAliasSource = `
      export async function PUT(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let RequestCtor;
    ...
    `;
    const unsafeGlobalThisAliasComputedNonNullTypeAssertedRequestSource = `
      export async function PATCH(req: Request) {
        const root = globalThis;
        const requestConstructorName = "Request";
    ...
    `;
    const unsafeWholeParenthesizedGlobalThisAliasComputedNonNullTypeAssertedRequestSource = `
      export async function DELETE(req: Request) {
        const root = globalThis as typeof globalThis;
        const requestConstructorName = "Request" as const;
        const RequestCtor = (root?.[requestConstructorName]! as typeof Request);
    ...
    `;
    const unsafeAssignedGlobalThisAliasComputedNonNullTypeAssertedRequestSource = `
      export async function PUT(req: Request) {
        const root = globalThis;
        const requestConstructorName = "Request";
        let RequestCtor;
        RequestCtor = root?.[requestConstructorName]! as typeof Request;
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ payload });
    ...
    `;
    const unsafeAssignedWholeParenthesizedGlobalThisAliasComputedNonNullTypeAssertedRequestSource = `
      export async function PATCH(req: Request) {
        const root = globalThis;
        const requestConstructorName = "Request";
        let RequestCtor;
    ...
    `;
    const unsafeAssignedTypeAssertedGlobalThisRootAliasComputedNonNullRequestSource = `
      export async function PUT(req: Request) {
        let root;
        root = globalThis as typeof globalThis;
        const requestConstructorName = "Request" as const;
    ...
    `;
    const unsafeAssignedSatisfiesGlobalThisRootAliasComputedNonNullRequestSource = `
      export async function PATCH(req: Request) {
        let root;
        root = (globalThis satisfies typeof globalThis);
        const requestConstructorName = "Request" as const;
    ...
    `;
    const unsafeAssignedTypeAssertedDirectPrototypeAliasSource = `
      export async function PATCH(req: Request) {
        let requestPrototype;
        requestPrototype = Request.prototype as typeof Request.prototype;
        const payload = await requestPrototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ payload });
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedTypeAssertedOptionalBracketGlobalThisRequestAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeAssignedNonNullOptionalDotGlobalThisRequestAliasSource, "PUT")
    ).toBe(true);
    expect(
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeTypeAssertedOptionalDotGlobalThisRequestAliasSource, "PATCH")
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeSatisfiesOptionalDotGlobalThisRequestAliasSource, "PATCH")).toBe(
      true
    );
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeOptionalBracketGlobalThisRequestAliasSource, "DELETE")).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeTypeAssertedOptionalBracketGlobalThisRequestAliasSource, "DELETE")
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeSatisfiesOptionalBracketGlobalThisRequestAliasSource, "DELETE")
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeNonNullOptionalDotGlobalThisRequestAliasSource, "PATCH")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeNonNullOptionalBracketGlobalThisRequestAliasSource, "DELETE")
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeComputedGlobalThisRequestAliasSource, "POST")).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeComputedNonNullOptionalGlobalThisRequestAliasSource, "POST")
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeTypeAssertedComputedNonNullOptionalGlobalThisRequestAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeSatisfiesComputedNonNullOptionalGlobalThisRequestAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeAssignedComputedNonNullOptionalGlobalThisRequestAliasSource, "PUT")
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedComputedSatisfiesNonNullOptionalGlobalThisRequestAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeComputedDestructuredGlobalThisRequestAliasSource, "DELETE")).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeAssignedDestructuredGlobalThisRequestAliasSource, "PUT")).toBe(
      true
    );
    expect(
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeDefaultedDestructuredGlobalThisRequestAliasSource, "PUT")
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeDefaultedComputedDestructuredGlobalThisRequestAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeAssignedDefaultedDestructuredGlobalThisRequestAliasSource, "POST")
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeRootAliasDefaultedDestructuredGlobalThisRequestAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeRootAliasDefaultedComputedDestructuredGlobalThisRequestAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedRootAliasDefaultedDestructuredGlobalThisRequestAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedTypeAssertedRootAliasDefaultedDestructuredGlobalThisRequestAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedRootAliasDefaultedComputedDestructuredGlobalThisRequestAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedSatisfiesRootAliasDefaultedComputedDestructuredGlobalThisRequestAliasSource,
        "PUT"
      )
    ).toBe(true);
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeGlobalThisAliasComputedNonNullTypeAssertedRequestSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeWholeParenthesizedGlobalThisAliasComputedNonNullTypeAssertedRequestSource,
        "DELETE"
      )
    ).toBe(true);
    expect(
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedGlobalThisAliasComputedNonNullTypeAssertedRequestSource,
        "PUT"
      )
    ).toBe(true);
    expect(
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedGlobalThisAliasComputedNonNullSatisfiesRequestSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedTypeAssertedGlobalThisRootAliasComputedNonNullRequestSource,
        "PUT"
      )
    ).toBe(true);
    expect(
  ...
  it("treats globalThis Object and Reflect body-reader lookups as body parsing for role-gate ordering", () => {
    ...
    `;
    const unsafeTypeAssertedDestructuredGlobalReflectSource = `
      export async function DELETE(req: Request) {
        const { Reflect: ReflectBuiltin } = globalThis as typeof globalThis;
        const payload = await ReflectBuiltin.get(req, "json").call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json(payload);
    ...
    `;
    const unsafeSatisfiesDestructuredGlobalObjectSource = `
      export async function POST(req: Request) {
        const { Object: ObjectBuiltin, Reflect: ReflectBuiltin } = (globalThis satisfies typeof globalThis);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "text"
        )?.value.call(req);
    ...
    `;
    const unsafeTypeAssertedComputedDestructuredGlobalBuiltinsSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = ("Reflect");
        const { [objectName]: ObjectBuiltin, [reflectName]: ReflectBuiltin } = (globalThis as typeof globalThis);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "blob"
        )?.value.call(req);
    ...
    `;
    const unsafeSatisfiesComputedDestructuredGlobalBuiltinsSource = `
      export async function PATCH(req: Request) {
        const objectName = ("Object");
        const reflectName = "Reflect" as const;
        const { [objectName]: ObjectBuiltin, [reflectName]: ReflectBuiltin } = (globalThis satisfies typeof globalThis);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "arrayBuffer"
        )?.value.call(req);
    ...
    `;
    const unsafeAssignedDefaultedDestructuredGlobalBuiltinsSource = `
      export async function PUT(req: Request) {
        let ObjectBuiltin;
        let ReflectBuiltin;
        ({ Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = globalThis);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "json"
        )?.value.call(req);
    ...
    `;
    const unsafeAssignedDefaultedComputedDestructuredGlobalBuiltinsSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = ("Reflect");
        let ObjectBuiltin;
        let ReflectBuiltin;
        ({ [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = globalThis);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "text"
        )?.value.call(req);
    ...
    `;
    const unsafeTypeAssertedDefaultedDestructuredGlobalBuiltinsSource = `
      export async function POST(req: Request) {
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = (globalThis as typeof globalThis);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "formData"
        )?.value.call(req);
    ...
    `;
    const unsafeSatisfiesDefaultedComputedDestructuredGlobalBuiltinsSource = `
      export async function PUT(req: Request) {
        const objectName = ("Object");
        const reflectName = "Reflect" as const;
        const { [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } =
          (globalThis satisfies typeof globalThis);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "blob"
        )?.value.call(req);
    ...
    `;
    const unsafeAssignedTypeAssertedDefaultedDestructuredGlobalBuiltinsSource = `
      export async function PATCH(req: Request) {
        let ObjectBuiltin;
        let ReflectBuiltin;
        ({ Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = (globalThis as typeof globalThis));
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "arrayBuffer"
        )?.value.call(req);
    ...
    `;
    const unsafeAssignedSatisfiesDefaultedComputedDestructuredGlobalBuiltinsSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = ("Reflect");
        let ObjectBuiltin;
        let ReflectBuiltin;
        ({ [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } =
          (globalThis satisfies typeof globalThis));
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "json"
    ...
    `;
    const unsafeRootAliasDefaultedDestructuredGlobalBuiltinsSource = `
      export async function POST(req: Request) {
        const root = globalThis;
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = root;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "arrayBuffer"
        )?.value.call(req);
    ...
    `;
    const unsafeRootAliasDefaultedComputedDestructuredGlobalBuiltinsSource = `
      export async function PATCH(req: Request) {
        const root = globalThis as typeof globalThis;
        const objectName = "Object" as const;
        const reflectName = ("Reflect");
        const { [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = root;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "blob"
        )?.value.call(req);
    ...
    `;
    const unsafeAssignedRootAliasDefaultedDestructuredGlobalBuiltinsSource = `
      export async function PUT(req: Request) {
        let root;
        let ObjectBuiltin;
        let ReflectBuiltin;
        root = (globalThis satisfies typeof globalThis);
        ({ Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = root);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "formData"
        )?.value.call(req);
    ...
    `;
    const unsafeAssignedTypeAssertedRootAliasDefaultedDestructuredGlobalBuiltinsSource = `
      export async function PUT(req: Request) {
        let root;
        let ObjectBuiltin;
        let ReflectBuiltin;
    ...
    `;
    const unsafeAssignedRootAliasDefaultedComputedDestructuredGlobalBuiltinsSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = ("Reflect");
        let root;
        ...
        let ReflectBuiltin;
        root = (globalThis as typeof globalThis);
        ({ [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = root);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "json"
        )?.value.call(req);
    ...
    `;
    const unsafeAssignedSatisfiesRootAliasDefaultedComputedDestructuredGlobalBuiltinsSource = `
      export async function PATCH(req: Request) {
        const objectName = "Object" as const;
        const reflectName = ("Reflect");
        let root;
    ...
    const unsafeAssignedTypeAssertedDestructuredGlobalObjectSource = `
      export async function PATCH(req: Request) {
        let ObjectBuiltin;
        ({ Object: ObjectBuiltin } = (globalThis as typeof globalThis));
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(Request.prototype, "formData")?.value.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ ok: Boolean(payload) });
      }
    ...
    const unsafeAssignedSatisfiesDestructuredGlobalReflectSource = `
      export async function DELETE(req: Request) {
        ...
        let ObjectBuiltin;
        let ReflectBuiltin;
        ({ [objectName]: ObjectBuiltin, Reflect: ReflectBuiltin } = (globalThis satisfies typeof globalThis));
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "arrayBuffer"
        )?.value.call(req);
    ...
    `;
    const unsafeTypeAssertedDestructuredGlobalRequestSource = `
      export async function PUT(req: Request) {
        const { Request: RequestBuiltin } = globalThis as typeof globalThis;
        const payload = await RequestBuiltin.prototype.blob.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ size: payload.size });
      }
    `;
    const unsafeGlobalThisReflectAliasSource = `
      export async function DELETE(req: Request) {
        const ReflectBuiltin = globalThis.Reflect;
        const payload = await ReflectBuiltin.get(req, "json").call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json(payload);
    ...
    `;
    const unsafeTypeAssertedGlobalThisRootReflectSource = `
      export async function DELETE(req: Request) {
    ...
    const unsafeAssignedGlobalThisBracketObjectAliasSource = `
      export async function PATCH(req: Request) {
        let ObjectBuiltin;
        ObjectBuiltin = globalThis["Object"];
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          globalThis["Reflect"].getPrototypeOf(req),
          "text"
        )?.value.call(req);
    ...
    `;
    const unsafeGlobalThisAliasComputedReflectAliasSource = `
      export async function PUT(req: Request) {
        const root = globalThis;
        const builtInName = "Reflect" as const;
        const ReflectBuiltin = root[builtInName];
        const payload = await ReflectBuiltin.apply(req.clone().arrayBuffer, req.clone(), []);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
        return Response.json({ size: payload.byteLength });
      }
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeTypeAssertedDestructuredGlobalReflectSource, "DELETE")).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeSatisfiesDestructuredGlobalObjectSource, "POST")).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeTypeAssertedComputedDestructuredGlobalBuiltinsSource, "DELETE")).toBe(
      true
    );
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeAssignedDefaultedDestructuredGlobalBuiltinsSource, "PUT")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedDefaultedComputedDestructuredGlobalBuiltinsSource,
        "DELETE"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeTypeAssertedDefaultedDestructuredGlobalBuiltinsSource, "POST")
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeSatisfiesDefaultedComputedDestructuredGlobalBuiltinsSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedTypeAssertedDefaultedDestructuredGlobalBuiltinsSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedSatisfiesDefaultedComputedDestructuredGlobalBuiltinsSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeRootAliasDefaultedDestructuredGlobalBuiltinsSource, "POST")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeRootAliasDefaultedComputedDestructuredGlobalBuiltinsSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedRootAliasDefaultedDestructuredGlobalBuiltinsSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedTypeAssertedRootAliasDefaultedDestructuredGlobalBuiltinsSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedRootAliasDefaultedComputedDestructuredGlobalBuiltinsSource,
        "DELETE"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedSatisfiesRootAliasDefaultedComputedDestructuredGlobalBuiltinsSource,
        "PATCH"
      )
    ).toBe(true);
  ...
  it("treats transitive local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeTransitiveRequestRootAliasSource = `
      export async function POST(req: Request) {
        const root = globalThis;
        const platform = root;
    ...
    `;
    const unsafeAssignedTransitiveRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let platform;
    ...
    `;
    const unsafeTransitiveBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        const root = globalThis as typeof globalThis;
        const platform = root;
    ...
    `;
    const unsafeAssignedTransitiveBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = ("Reflect");
        let root;
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeTransitiveRequestRootAliasSource, "POST")).toBe(true);
  ...
  it("treats multi-hop comma-declared transitive local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeCommaDeclaredMultiHopRequestRootAliasSource = `
      export async function POST(req: Request) {
        const root = globalThis, platform = root, runtime = platform;
    ...
    `;
    const unsafeCommaDeclaredMultiHopComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        const root = globalThis as typeof globalThis, platform = root, runtime = platform;
    ...
    `;
    const unsafeCommaDeclaredMultiHopBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        const root = globalThis satisfies typeof globalThis, platform = root, runtime = platform;
    ...
    `;
    const unsafeCommaDeclaredMultiHopComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const, reflectName = "Reflect" as const;
        const root = globalThis, platform = root, runtime = platform;
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeCommaDeclaredMultiHopRequestRootAliasSource, "POST")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeCommaDeclaredMultiHopComputedRequestRootAliasSource, "PATCH")
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeCommaDeclaredMultiHopBuiltinsRootAliasSource, "PUT")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeCommaDeclaredMultiHopComputedBuiltinsRootAliasSource, "DELETE")
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  });

  it("treats multi-hop comma-declared non-null local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeCommaDeclaredMultiHopNonNullRequestRootAliasSource = `
      export async function POST(req: Request) {
        const root = globalThis, platform = root!, runtime = platform!;
        const { Request: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.json.call(req);
    ...
    `;
    const unsafeCommaDeclaredMultiHopNonNullComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        const root = globalThis as typeof globalThis, platform = root!, runtime = platform! satisfies typeof globalThis;
        const { [requestConstructorName]: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeCommaDeclaredMultiHopNonNullBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        const root = globalThis, platform = root! as typeof globalThis, runtime = platform!;
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "formData"
    ...
    `;
    const unsafeCommaDeclaredMultiHopNonNullComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const, reflectName = "Reflect" as const;
        const root = globalThis satisfies typeof globalThis, platform = root!, runtime = platform! as typeof globalThis;
        const { [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "blob"
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeCommaDeclaredMultiHopNonNullRequestRootAliasSource, "POST")
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeCommaDeclaredMultiHopNonNullComputedRequestRootAliasSource, "PATCH")
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeCommaDeclaredMultiHopNonNullBuiltinsRootAliasSource, "PUT")
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeCommaDeclaredMultiHopNonNullComputedBuiltinsRootAliasSource, "DELETE")
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  });

  it("treats multi-hop comma-declared parenthesized non-null local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeCommaDeclaredMultiHopParenthesizedNonNullRequestRootAliasSource = `
      export async function POST(req: Request) {
        const root = globalThis, platform = (root)! as typeof globalThis, runtime = ((platform as typeof globalThis)!);
        const { Request: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.json.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeCommaDeclaredMultiHopParenthesizedNonNullComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        const root = globalThis as typeof globalThis, platform = ((root as typeof globalThis)!), runtime = ((platform satisfies typeof globalThis)!);
        const { [requestConstructorName]: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeCommaDeclaredMultiHopParenthesizedNonNullBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        const root = globalThis, platform = (root)! as typeof globalThis, runtime = ((platform as typeof globalThis)!);
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
    ...
    `;
    const unsafeCommaDeclaredMultiHopParenthesizedNonNullComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const, reflectName = "Reflect" as const;
        const root = globalThis satisfies typeof globalThis, platform = ((root satisfies typeof globalThis)!), runtime = (platform)! as typeof globalThis;
        const { [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "blob"
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredMultiHopParenthesizedNonNullRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredMultiHopParenthesizedNonNullComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredMultiHopParenthesizedNonNullBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredMultiHopParenthesizedNonNullComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats multi-hop comma-declared whole-parenthesized non-null local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeCommaDeclaredMultiHopWholeParenthesizedNonNullRequestRootAliasSource = `
      export async function POST(req: Request) {
        const root = (globalThis)!, platform = ((root)!), runtime = ((platform)!);
        const { Request: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.json.call(req);
    ...
    `;
    const unsafeCommaDeclaredMultiHopWholeParenthesizedNonNullComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        const root = ((globalThis as typeof globalThis)!), platform = ((root)! satisfies typeof globalThis), runtime = ((platform)! as typeof globalThis);
        const { [requestConstructorName]: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeCommaDeclaredMultiHopWholeParenthesizedNonNullBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        const root = (globalThis)!, platform = ((root)!), runtime = ((platform)!);
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
    ...
    `;
    const unsafeCommaDeclaredMultiHopWholeParenthesizedNonNullComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const, reflectName = "Reflect" as const;
        const root = ((globalThis satisfies typeof globalThis)!), platform = ((root)! as typeof globalThis), runtime = ((platform)! satisfies typeof globalThis);
        const { [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "blob"
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredMultiHopWholeParenthesizedNonNullRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredMultiHopWholeParenthesizedNonNullComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredMultiHopWholeParenthesizedNonNullBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredMultiHopWholeParenthesizedNonNullComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats mixed declaration and assignment multi-hop local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeMixedMultiHopRequestRootAliasSource = `
      export async function POST(req: Request) {
        const root = globalThis;
        let platform;
        platform = root;
    ...
    `;
    const unsafeMixedMultiHopComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        const root = (globalThis) as typeof globalThis;
        let platform;
        platform = root satisfies typeof globalThis;
        const runtime = platform as typeof globalThis;
        const { [requestConstructorName]: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeMixedMultiHopBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root;
        root = globalThis satisfies typeof globalThis;
        const platform = root;
    ...
    `;
    const unsafeMixedMultiHopComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        const root = ((globalThis as typeof globalThis)!);
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeMixedMultiHopRequestRootAliasSource, "POST")).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeMixedMultiHopComputedRequestRootAliasSource, "PATCH")).toBe(
      true
    );
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeMixedMultiHopBuiltinsRootAliasSource, "PUT")).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeMixedMultiHopComputedBuiltinsRootAliasSource, "DELETE")
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  });

  it("treats let and var mixed multi-hop local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeLetVarMixedMultiHopRequestRootAliasSource = `
      export async function POST(req: Request) {
        let root = globalThis;
        var platform = root;
        let runtime;
    ...
    `;
    const unsafeLetVarMixedMultiHopComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root = (globalThis as typeof globalThis);
        var platform = ((root)! satisfies typeof globalThis);
        let runtime;
        runtime = platform as typeof globalThis;
        const { [requestConstructorName]: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.text.call(req);
    ...
    `;
    const unsafeLetVarMixedMultiHopBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        var root = globalThis satisfies typeof globalThis;
        let platform = root!;
        var runtime = platform! as typeof globalThis;
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "formData"
    ...
    `;
    const unsafeLetVarMixedMultiHopComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root = ((globalThis as typeof globalThis)!);
        ...
        let ReflectBuiltin;
        platform = ((root)! as typeof globalThis);
        const runtime = ((platform)! satisfies typeof globalThis);
        ({ [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = runtime);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "blob"
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeLetVarMixedMultiHopRequestRootAliasSource, "POST")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeLetVarMixedMultiHopComputedRequestRootAliasSource, "PATCH")
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeLetVarMixedMultiHopBuiltinsRootAliasSource, "PUT")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeLetVarMixedMultiHopComputedBuiltinsRootAliasSource, "DELETE")
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  });
  ...
  it("treats parenthesized assignment non-null multi-hop local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeParenthesizedAssignmentNonNullRequestRootAliasSource = `
      export async function POST(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeParenthesizedAssignmentNonNullComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let platform;
    ...
    `;
    const unsafeParenthesizedAssignmentNonNullBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeParenthesizedAssignmentNonNullComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root;
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeParenthesizedAssignmentNonNullRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeParenthesizedAssignmentNonNullComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeParenthesizedAssignmentNonNullBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeParenthesizedAssignmentNonNullComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats parenthesized assignment comma-expression local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeCommaExpressionRequestRootAliasSource = `
      export async function POST(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeCommaExpressionComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let platform;
    ...
    `;
    const unsafeCommaExpressionBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeCommaExpressionNonNullComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root;
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeCommaExpressionRequestRootAliasSource, "POST")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeCommaExpressionComputedRequestRootAliasSource, "PATCH")
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeCommaExpressionBuiltinsRootAliasSource, "PUT")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaExpressionNonNullComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats parenthesized assignment comma-expression non-null local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeCommaExpressionNonNullRequestRootAliasSource = `
      export async function POST(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeCommaExpressionNonNullComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let platform;
    ...
    `;
    const unsafeCommaExpressionNonNullBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaExpressionNonNullRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaExpressionNonNullComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaExpressionNonNullBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
  ...
  it("treats nullish, fallback, and logical-and assignment local globalThis root aliases as body parsing for role-gate ordering", () => {
    ...
    `;
    const unsafeLogicalAssignmentComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let platform;
    ...
    `;
    const unsafeLogicalAssignmentBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeLogicalAssignmentComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root;
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeLogicalAssignmentRequestRootAliasSource, "POST")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeLogicalAssignmentComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeLogicalAssignmentBuiltinsRootAliasSource, "PUT")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
  ...
  it("treats simple sequence-expression local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeSequenceExpressionRequestRootAliasSource = `
      export async function POST(req: Request) {
        let root;
        let platform;
        let runtime;
        root = (void 0, globalThis);
        platform = (undefined, root);
        runtime = (0, platform);
        const { Request: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.json.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
    ...
    `;
    const unsafeSequenceExpressionComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let platform;
        let runtime;
        const root = (void 0, ((globalThis as typeof globalThis)!));
        platform = (undefined, ((root)! satisfies typeof globalThis));
        runtime = (0, ((platform)! as typeof globalThis));
        const { [requestConstructorName]: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeSequenceExpressionBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root;
        let platform;
        let runtime;
        root = (void 0, globalThis satisfies typeof globalThis);
        platform = (undefined, root);
        runtime = (0, platform satisfies typeof globalThis);
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "formData"
    ...
    `;
    const unsafeSequenceExpressionComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root;
        ...
        let ReflectBuiltin;
        ((root = (void 0, ((globalThis satisfies typeof globalThis)!))));
        ((platform = (undefined, ((root)! as typeof globalThis))));
        ((runtime = (0, ((platform)! satisfies typeof globalThis))));
        ({ [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = runtime);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeSequenceExpressionRequestRootAliasSource, "POST")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeSequenceExpressionComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeSequenceExpressionBuiltinsRootAliasSource, "PUT")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeSequenceExpressionComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats comma-declared sequence-expression local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeCommaDeclaredSequenceExpressionRequestRootAliasSource = `
      export async function POST(req: Request) {
        const root = (void 0, globalThis), platform = (undefined, root), runtime = (0, platform);
        const { Request: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.json.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeCommaDeclaredSequenceExpressionComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        const root = (void 0, ((globalThis as typeof globalThis)!)),
          platform = (undefined, ((root)! satisfies typeof globalThis)),
    ...
    `;
    const unsafeCommaDeclaredSequenceExpressionBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        const root = (void 0, globalThis satisfies typeof globalThis), platform = (undefined, root), runtime = (0, platform satisfies typeof globalThis);
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "formData"
    ...
    `;
    const unsafeCommaDeclaredSequenceExpressionComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        const root = (void 0, ((globalThis satisfies typeof globalThis)!)),
          platform = (undefined, ((root)! as typeof globalThis)),
          runtime = (0, ((platform)! satisfies typeof globalThis));
        const { [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredSequenceExpressionRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredSequenceExpressionComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredSequenceExpressionBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredSequenceExpressionComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats comma-declared logical-expression local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeCommaDeclaredLogicalExpressionRequestRootAliasSource = `
      export async function POST(req: Request) {
        const root = globalThis || globalThis, platform = root ?? root, runtime = platform && platform;
        const { Request: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.json.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeCommaDeclaredLogicalExpressionComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        const root = ((globalThis as typeof globalThis) || (globalThis satisfies typeof globalThis)),
          platform = ((root)! satisfies typeof globalThis) ?? ((root)! as typeof globalThis),
          runtime = ((platform)! as typeof globalThis) && ((platform)! satisfies typeof globalThis);
        const { [requestConstructorName]: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeCommaDeclaredLogicalExpressionBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        const root = globalThis satisfies typeof globalThis || globalThis, platform = root && root, runtime = platform ?? platform satisfies typeof globalThis;
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "formData"
    ...
    `;
    const unsafeCommaDeclaredLogicalExpressionComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        const root = ((globalThis satisfies typeof globalThis) || ((globalThis as typeof globalThis)!)),
          platform = ((root)! as typeof globalThis) && ((root)! satisfies typeof globalThis),
          runtime = ((platform)! satisfies typeof globalThis) ?? ((platform)! as typeof globalThis);
        const { [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "blob"
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredLogicalExpressionRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredLogicalExpressionComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredLogicalExpressionBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredLogicalExpressionComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats comma-declared sequence-wrapped conditional and logical local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeCommaDeclaredSequenceConditionalRequestRootAliasSource = `
      export async function POST(req: Request) {
        const condition = true;
        const root = (void 0, condition ? globalThis : globalThis),
    ...
    `;
    const unsafeCommaDeclaredSequenceLogicalComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
    ...
    `;
    const unsafeCommaDeclaredSequenceConditionalBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        const condition = true;
        const root = (null, condition ? globalThis satisfies typeof globalThis : globalThis),
    ...
    `;
    const unsafeCommaDeclaredSequenceLogicalComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        const root = (void 0, ((globalThis satisfies typeof globalThis) || ((globalThis as typeof globalThis)!))),
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredSequenceConditionalRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredSequenceLogicalComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredSequenceConditionalBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredSequenceLogicalComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats typed comma-declared sequence-wrapped local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeTypedCommaDeclaredSequenceConditionalRequestRootAliasSource = `
      export async function POST(req: Request) {
        const condition = true;
        const root: typeof globalThis = (void 0, condition ? globalThis : globalThis),
          platform: typeof globalThis = (undefined, condition ? root : root),
          runtime: typeof globalThis = (0, true ? platform : platform);
        const { Request: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.json.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeTypedCommaDeclaredSequenceLogicalComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        const root: typeof globalThis = (void 0, globalThis || globalThis),
          platform: typeof globalThis = (undefined, root ?? root),
          runtime: typeof globalThis = (0, platform && platform);
        const { [requestConstructorName]: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeTypedCommaDeclaredSequenceConditionalBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        const condition = true;
        const root: typeof globalThis = (null, condition ? globalThis : globalThis),
          platform: typeof globalThis = (false, condition ? root : root),
          runtime: typeof globalThis = (true, condition ? platform : platform);
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "formData"
    ...
    `;
    const unsafeTypedCommaDeclaredSequenceLogicalComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        const root: typeof globalThis = (void 0, globalThis || globalThis),
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeTypedCommaDeclaredSequenceConditionalRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeTypedCommaDeclaredSequenceLogicalComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeTypedCommaDeclaredSequenceConditionalBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeTypedCommaDeclaredSequenceLogicalComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats asserted typed comma-declared sequence-wrapped local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeAssertedTypedCommaDeclaredSequenceRequestRootAliasSource = `
      export async function POST(req: Request) {
        const root: typeof globalThis = (void 0, ((globalThis as typeof globalThis)!)),
          platform: typeof globalThis = (undefined, ((root)! satisfies typeof globalThis)),
          runtime: typeof globalThis = (0, ((platform as typeof globalThis)!));
        const { Request: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.json.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeAssertedTypedCommaDeclaredSequenceComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        const root: typeof globalThis = (void 0, ((globalThis satisfies typeof globalThis)!)),
          platform: typeof globalThis = (undefined, ((root as typeof globalThis)!)),
          runtime: typeof globalThis = (0, ((platform)! satisfies typeof globalThis));
        const { [requestConstructorName]: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeAssertedTypedCommaDeclaredSequenceBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        const root: typeof globalThis = (null, ((globalThis as typeof globalThis)!)),
          platform: typeof globalThis = (false, ((root)! as typeof globalThis)),
          runtime: typeof globalThis = (true, ((platform satisfies typeof globalThis)!));
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "formData"
    ...
    `;
    const unsafeAssertedTypedCommaDeclaredSequenceComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        const root: typeof globalThis = (void 0, ((globalThis satisfies typeof globalThis)!)),
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssertedTypedCommaDeclaredSequenceRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssertedTypedCommaDeclaredSequenceComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssertedTypedCommaDeclaredSequenceBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssertedTypedCommaDeclaredSequenceComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats conditional-expression local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeConditionalExpressionRequestRootAliasSource = `
      export async function POST(req: Request) {
        ...
        let platform;
        let runtime;
        root = condition ? globalThis : globalThis;
        platform = condition ? root : root;
        runtime = true ? platform : platform;
        const { Request: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.json.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeConditionalExpressionComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const condition = true;
        const requestConstructorName = "Request" as const;
        let platform;
    ...
    `;
    const unsafeConditionalExpressionBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        const condition = true;
        let root;
        let platform;
        let runtime;
        root = condition ? globalThis satisfies typeof globalThis : globalThis;
        platform = false ? root : root;
        runtime = condition ? platform satisfies typeof globalThis : platform;
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "formData"
    ...
    `;
    const unsafeConditionalExpressionComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const condition = true;
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        ...
        let ObjectBuiltin;
        let ReflectBuiltin;
        ((root = condition ? ((globalThis satisfies typeof globalThis)!) : ((globalThis as typeof globalThis)!)));
        ((platform = false ? ((root)! as typeof globalThis) : ((root)! satisfies typeof globalThis)));
        ((runtime = condition ? ((platform)! satisfies typeof globalThis) : ((platform)! as typeof globalThis)));
        ({ [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = runtime);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeConditionalExpressionRequestRootAliasSource, "POST")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeConditionalExpressionComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeConditionalExpressionBuiltinsRootAliasSource, "PUT")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeConditionalExpressionComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats logical-expression local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeLogicalExpressionRequestRootAliasSource = `
      export async function POST(req: Request) {
        let root;
        let platform;
        let runtime;
        root = globalThis || globalThis;
        platform = root ?? root;
    ...
    `;
    const unsafeLogicalExpressionComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let platform;
        let runtime;
    ...
    `;
    const unsafeLogicalExpressionBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root;
        let platform;
        let runtime;
        root = globalThis satisfies typeof globalThis || globalThis;
        platform = root && root;
        runtime = platform ?? platform satisfies typeof globalThis;
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "formData"
    ...
    `;
    const unsafeLogicalExpressionComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root;
        ...
        let ObjectBuiltin;
        let ReflectBuiltin;
        ((root = ((globalThis satisfies typeof globalThis) || ((globalThis as typeof globalThis)!))));
        ((platform = ((root)! as typeof globalThis) && ((root)! satisfies typeof globalThis)));
        ((runtime = ((platform)! satisfies typeof globalThis) ?? ((platform)! as typeof globalThis)));
        ({ [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = runtime);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeLogicalExpressionRequestRootAliasSource, "POST")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeLogicalExpressionComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeLogicalExpressionBuiltinsRootAliasSource, "PUT")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeLogicalExpressionComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats sequence-wrapped logical-assignment local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeSequenceLogicalAssignmentRequestRootAliasSource = `
      export async function POST(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeSequenceLogicalAssignmentComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let platform;
        let runtime;
        root ??= (void 0, ((globalThis as typeof globalThis)!));
        platform ||= (undefined, ((root)! satisfies typeof globalThis));
        runtime &&= (0, ((platform)! as typeof globalThis));
        const { [requestConstructorName]: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.text.call(req);
    ...
    `;
    const unsafeSequenceLogicalAssignmentBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root;
        let platform;
        let runtime;
        root ||= (null, globalThis satisfies typeof globalThis);
        platform ??= (false, root);
        runtime &&= (true, platform satisfies typeof globalThis);
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "formData"
    ...
    `;
    const unsafeSequenceLogicalAssignmentComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root;
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeSequenceLogicalAssignmentRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeSequenceLogicalAssignmentComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeSequenceLogicalAssignmentBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeSequenceLogicalAssignmentComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats sequence-wrapped expression logical-assignment local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeSequenceExpressionLogicalAssignmentRequestRootAliasSource = `
      export async function POST(req: Request) {
        const condition = true;
        let root;
        let platform;
    ...
    `;
    const unsafeSequenceExpressionLogicalAssignmentComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let platform;
        let runtime;
        root ||= (void 0, ((globalThis as typeof globalThis)!) || ((globalThis satisfies typeof globalThis)!));
        platform ??= (undefined, ((root)! as typeof globalThis) && ((root)! satisfies typeof globalThis));
        runtime &&= (0, ((platform)! satisfies typeof globalThis) ?? ((platform)! as typeof globalThis));
        const { [requestConstructorName]: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.text.call(req);
    ...
    `;
    const unsafeSequenceExpressionLogicalAssignmentBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        const condition = true;
        let root;
        let platform;
    ...
    `;
    const unsafeSequenceExpressionLogicalAssignmentComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root;
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeSequenceExpressionLogicalAssignmentRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeSequenceExpressionLogicalAssignmentComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeSequenceExpressionLogicalAssignmentBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeSequenceExpressionLogicalAssignmentComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats asserted typed sequence-wrapped expression logical-assignment local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeAssertedTypedSequenceExpressionLogicalAssignmentRequestRootAliasSource = `
      export async function POST(req: Request) {
        let root: typeof globalThis;
        let platform: typeof globalThis;
        let runtime: typeof globalThis;
        root ??= (void 0, ((globalThis as typeof globalThis)!));
        platform ||= (undefined, ((root)! satisfies typeof globalThis));
        runtime &&= (0, ((platform as typeof globalThis)!));
        const { Request: RequestCtor = Request } = runtime;
    ...
    `;
    const unsafeAssertedTypedSequenceExpressionLogicalAssignmentComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root: typeof globalThis;
        let platform: typeof globalThis;
    ...
    `;
    const unsafeAssertedTypedSequenceExpressionLogicalAssignmentBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root: typeof globalThis;
        let platform: typeof globalThis;
        let runtime: typeof globalThis;
    ...
    `;
    const unsafeAssertedTypedSequenceExpressionLogicalAssignmentComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root: typeof globalThis;
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssertedTypedSequenceExpressionLogicalAssignmentRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssertedTypedSequenceExpressionLogicalAssignmentComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssertedTypedSequenceExpressionLogicalAssignmentBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssertedTypedSequenceExpressionLogicalAssignmentComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats comma-expression sequence-wrapped logical-assignment local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeCommaSequenceLogicalAssignmentRequestRootAliasSource = `
      export async function POST(req: Request) {
        const condition = true;
        let root = {};
        let platform = {};
        let runtime = {};
        ((root ??= (void 0, condition ? globalThis : globalThis)), (platform ||= (undefined, root ?? root)), (runtime &&= (0, platform && platform)));
        const { Request: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.json.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeCommaSequenceLogicalAssignmentComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root = {};
        let platform = {};
        let runtime = {};
        (((root ||= (void 0, ((globalThis as typeof globalThis)!) || ((globalThis satisfies typeof globalThis)!))), (platform ??= (undefined, ((root)! satisfies typeof globalThis) && ((root)! as typeof globalThis))), (runtime &&= (0, ((platform)! as typeof globalThis) ?? ((platform)! satisfies typeof globalThis)))));
        const { [requestConstructorName]: RequestCtor = Request } = runtime;
        const payload = await RequestCtor.prototype.text.call(req);
        const roleResponse = requireApiRole(currentOrg, MembershipRole.ADMIN);
        if (roleResponse) return roleResponse;
    ...
    `;
    const unsafeCommaSequenceLogicalAssignmentBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        const condition = true;
        let root = {};
        let platform = {};
        let runtime = {};
        ((root &&= (void 0, condition ? globalThis : globalThis)), (platform ||= (undefined, condition ? root : root)), (runtime ??= (0, platform && platform)));
        const { Object: ObjectBuiltin = Object, Reflect: ReflectBuiltin = Reflect } = runtime;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "formData"
    ...
    `;
    const unsafeCommaSequenceLogicalAssignmentComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root = {};
        ...
        let ObjectBuiltin;
        let ReflectBuiltin;
        (((root ??= (void 0, ((globalThis satisfies typeof globalThis)!) || ((globalThis as typeof globalThis)!))), (platform ||= (undefined, ((root)! as typeof globalThis) && ((root)! satisfies typeof globalThis))), (runtime &&= (0, ((platform)! satisfies typeof globalThis) ?? ((platform)! as typeof globalThis)))));
        ({ [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = runtime);
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "blob"
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaSequenceLogicalAssignmentRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaSequenceLogicalAssignmentComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaSequenceLogicalAssignmentBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaSequenceLogicalAssignmentComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats asserted typed comma-expression sequence-wrapped logical-assignment local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeAssertedTypedCommaSequenceLogicalAssignmentRequestRootAliasSource = `
      export async function POST(req: Request) {
        let root: typeof globalThis;
        let platform: typeof globalThis;
        let runtime: typeof globalThis;
    ...
    `;
    const unsafeAssertedTypedCommaSequenceLogicalAssignmentComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root: typeof globalThis;
        let platform: typeof globalThis;
    ...
    `;
    const unsafeAssertedTypedCommaSequenceLogicalAssignmentBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root: typeof globalThis;
        let platform: typeof globalThis;
        let runtime: typeof globalThis;
    ...
    `;
    const unsafeAssertedTypedCommaSequenceLogicalAssignmentComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root: typeof globalThis;
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssertedTypedCommaSequenceLogicalAssignmentRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssertedTypedCommaSequenceLogicalAssignmentComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssertedTypedCommaSequenceLogicalAssignmentBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssertedTypedCommaSequenceLogicalAssignmentComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats multi-hop assigned transitive local globalThis root aliases as body parsing for role-gate ordering", () => {
    ...
    `;
    const unsafeAssignedMultiHopComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let platform;
    ...
    `;
    const unsafeAssignedMultiHopBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeAssignedMultiHopComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root;
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeAssignedMultiHopRequestRootAliasSource, "POST")).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeAssignedMultiHopComputedRequestRootAliasSource, "PATCH")).toBe(
      true
    );
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeAssignedMultiHopBuiltinsRootAliasSource, "PUT")).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeAssignedMultiHopComputedBuiltinsRootAliasSource, "DELETE")
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  });

  it("treats multi-hop assigned parenthesized non-null local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeAssignedMultiHopParenthesizedNonNullRequestRootAliasSource = `
      export async function POST(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeAssignedMultiHopParenthesizedNonNullComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let platform;
    ...
    `;
    const unsafeAssignedMultiHopParenthesizedNonNullBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeAssignedMultiHopParenthesizedNonNullComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root;
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedMultiHopParenthesizedNonNullRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedMultiHopParenthesizedNonNullComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedMultiHopParenthesizedNonNullBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedMultiHopParenthesizedNonNullComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats multi-hop assigned whole-parenthesized non-null local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeAssignedMultiHopWholeParenthesizedNonNullRequestRootAliasSource = `
      export async function POST(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeAssignedMultiHopWholeParenthesizedNonNullComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let platform;
    ...
    `;
    const unsafeAssignedMultiHopWholeParenthesizedNonNullBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeAssignedMultiHopWholeParenthesizedNonNullComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root;
    ...
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedMultiHopWholeParenthesizedNonNullRequestRootAliasSource,
        "POST"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedMultiHopWholeParenthesizedNonNullComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedMultiHopWholeParenthesizedNonNullBuiltinsRootAliasSource,
        "PUT"
      )
    ).toBe(true);
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeAssignedMultiHopWholeParenthesizedNonNullComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats multi-hop assigned non-null local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeAssignedMultiHopNonNullRequestRootAliasSource = `
      export async function POST(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeAssignedMultiHopNonNullComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let platform;
    ...
    `;
    const unsafeAssignedMultiHopNonNullBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
        let root;
        let platform;
        let runtime;
    ...
    `;
    const unsafeAssignedMultiHopNonNullComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const;
        const reflectName = "Reflect" as const;
        let root;
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeAssignedMultiHopNonNullRequestRootAliasSource, "POST")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeAssignedMultiHopNonNullComputedRequestRootAliasSource, "PATCH")
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeAssignedMultiHopNonNullBuiltinsRootAliasSource, "PUT")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(unsafeAssignedMultiHopNonNullComputedBuiltinsRootAliasSource, "DELETE")
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  });
  ...
  it("treats comma-declared non-null transitive local globalThis root aliases as body parsing for role-gate ordering", () => {
    const unsafeCommaDeclaredNonNullTransitiveRequestRootAliasSource = `
      export async function POST(req: Request) {
        const root = globalThis, platform = root!;
        const { Request: RequestCtor = Request } = platform;
        const payload = await RequestCtor.prototype.json.call(req);
    ...
    `;
    const unsafeCommaDeclaredNonNullTransitiveComputedRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        const root = globalThis as typeof globalThis, platform = root! satisfies typeof globalThis;
    ...
    `;
    const unsafeCommaDeclaredNonNullTransitiveBuiltinsRootAliasSource = `
      export async function PUT(req: Request) {
    ...
    `;
    const unsafeCommaDeclaredNonNullTransitiveComputedBuiltinsRootAliasSource = `
      export async function DELETE(req: Request) {
        const objectName = "Object" as const, reflectName = "Reflect" as const;
        const root = globalThis satisfies typeof globalThis, platform = root!;
        const { [objectName]: ObjectBuiltin = Object, [reflectName]: ReflectBuiltin = Reflect } = platform;
        const payload = await ObjectBuiltin.getOwnPropertyDescriptor(
          ReflectBuiltin.getPrototypeOf(req),
          "blob"
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeCommaDeclaredNonNullTransitiveRequestRootAliasSource, "POST")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredNonNullTransitiveComputedRequestRootAliasSource,
        "PATCH"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeCommaDeclaredNonNullTransitiveBuiltinsRootAliasSource, "PUT")).toBe(
      true
    );
    expect(
      mutatingMethodParsesBodyBeforeRoleGate(
        unsafeCommaDeclaredNonNullTransitiveComputedBuiltinsRootAliasSource,
        "DELETE"
      )
    ).toBe(true);
    expect(mutatingMethodParsesBodyBeforeRoleGate(safeSource, "POST")).toBe(false);
  ...
  it("treats parenthesized non-null transitive local globalThis root aliases as body parsing for role-gate ordering", () => {
    ...
    `;
    const unsafeWholeParenthesizedNonNullTransitiveRequestRootAliasSource = `
      export async function PATCH(req: Request) {
        const requestConstructorName = "Request" as const;
        let root;
        let platform;
    ...
    expect(mutatingMethodParsesBodyBeforeRoleGate(unsafeParenthesizedNonNullTransitiveRequestRootAliasSource, "POST")).toBe(
      true
    );
    expect(
