...
- There is still no Redis-backed BullMQ end-to-end smoke against a running Redis service, no provider credential deletion endpoint, and no live send enablement flow.
