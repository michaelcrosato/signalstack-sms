...
- The local operator runbook is documentation plus a local validation check only. It does not add live operations, external integrations, destructive database commands, notifications, billing events, or provider calls.
